...
- [ ] 1.2 Configure the project for C++23 and the initial dependency set: GoogleTest/GoogleMock, nlohmann/json, CLI11, spdlog, and stduuid. (HTTP/TLS client is deferred to the model adapter task in section 4; libcurl/OpenSSL or a lighter alternative will be selected then.)
